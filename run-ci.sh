...
docker exec -t kuzzle1 /bin/sh -c '/scripts/run-kuzzle.sh' &
docker exec -t kuzzle2 /bin/sh -c '/scripts/run-kuzzle.sh' &
docker exec -t kuzzle3 /bin/sh -c '/scripts/run-kuzzle.sh' &
