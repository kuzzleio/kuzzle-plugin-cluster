...
KuzzleCluster.prototype.autoRefreshUpdated = function (request) {
  console.log('DEBUG: "autoRefreshUpdated" 1/2', request.input.resource.index, request.input.body.autoRefresh, typeof request.input.body.autoRefresh, this.node.isReady)
  if (!this.node || !this.node.isReady) {
    return;
  }
