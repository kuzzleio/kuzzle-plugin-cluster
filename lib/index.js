...
class KuzzleCluster {
  ...
  indexCacheReset (diff) {
    ...
    debug('[%s] broadcasting "index cache reset" action:\n%O', this.uuid, msg);
  ...
  profileUpdated (diff) {
    ...
    debug('[%s] broadcasting "profile update" action:\n%O', this.uuid, msg);
  ...
  roleUpdated (diff) {
    ...
    debug('[%s] broadcasting "role update" action:\n%O', this.uuid, msg);
...
function resolveBinding (hostConfig) {
  ...
  debug('resolving broker bindings with configuration:\n%O', hostConfig);
