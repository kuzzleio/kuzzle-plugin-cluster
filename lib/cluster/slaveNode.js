  ...
  this.broker.listen(`cluster:${this.clusterHandler.uuid}`, response => {
    switch (response.action) {
      case 'snapshot':
        ...
        this.kuzzle.dsl.storage.filtersIndex = response.data.fs.i;
        this.kuzzle.dsl.storage.filters = response.data.fs.f;
        this.kuzzle.dsl.storage.subfilters = response.data.fs.s;
        this.kuzzle.dsl.storage.conditions = response.data.fs.c;
        this.kuzzle.dsl.storage.foPairs = response.data.fs.fp;
        this.kuzzle.dsl.storage.testTables = response.data.fs.t;
